...
!(function (t, n) {
    ...
    if ((e && 2 !== e.length) || n.length > 1) {
      ...
      return (
        n.length > 1
          ...
          : ((e = t.map(e)), r.sort((t, n) => R(e[t], e[n]))),
        P(t, r)
      );
    }
    return t.sort(D(e));
  ...
  function Y(t, n, e) {
    var r = (n - t) / Math.max(0, e),
      ...
      o = r / Math.pow(10, i);
    return i >= 0
      ? (o >= O ? 10 : o >= U ? 5 : o >= I ? 2 : 1) * Math.pow(10, i)
      : -Math.pow(10, -i) / (o >= O ? 10 : o >= U ? 5 : o >= I ? 2 : 1);
  }
  function L(t, n, e) {
  ...
  function H() {
    ...
    function r(r) {
      ...
      var g,
        y = new Array(p + 1);
      for (i = 0; i <= p; ++i)
        ((g = y[i] = []).x0 = i > 0 ? d[i - 1] : l), (g.x1 = i < p ? d[i] : h);
      if (isFinite(a)) {
        if (a > 0)
          for (i = 0; i < u; ++i)
            null != (o = c[i]) &&
              l <= o &&
              o <= h &&
              y[Math.min(p, Math.floor((o - l) / a))].push(r[i]);
        else if (a < 0)
          for (i = 0; i < u; ++i)
      ...
      } else for (i = 0; i < u; ++i) null != (o = c[i]) && l <= o && o <= h && y[s(d, o, 0, p)].push(r[i]);
      return y;
    }
    return (
      (r.value = function (n) {
    ...
    on: function (t, n) {
      ...
      if (!(arguments.length < 2)) {
        ...
        for (; ++o < a; )
          ...
          else if (null == n) for (e in r) r[e] = At(r[e], t.name, null);
        return this;
      }
      for (; ++o < a; )
  ...
  function Ht(t, n, e, r, i, o) {
    for (var a, u = 0, c = n.length, f = o.length; u < f; ++u)
      (a = n[u]) ? ((a.__data__ = o[u]), (r[u] = a)) : (e[u] = new jt(t, o[u]));
  ...
  function un(t, n) {
    return (
      ...
      en(t).getComputedStyle(t, null).getPropertyValue(n)
    );
  }
  function cn(t) {
    return function () {
  ...
  function In() {
    return new Un([[document.documentElement]], On);
  }
  function Bn(t) {
    return "string" == typeof t
      ? new Un([[document.querySelector(t)]], [document.documentElement])
      : new Un([[t]], On);
  }
  Un.prototype = In.prototype = {
    ...
    style: function (t, n, e) {
      return arguments.length > 1
        ? this.each(
            (null == n ? rn : "function" == typeof n ? an : on)(
              t,
              n,
              null == e ? "" : e
            )
    ...
    property: function (t, n) {
      return arguments.length > 1
        ? this.each((null == n ? cn : "function" == typeof n ? sn : fn)(t, n))
        : this.node()[t];
    },
    ...
    text: function (t) {
      return arguments.length
        ? this.each(null == t ? bn : ("function" == typeof t ? xn : mn)(t))
        : this.node().textContent;
    },
    html: function (t) {
      return arguments.length
        ? this.each(null == t ? wn : ("function" == typeof t ? An : Mn)(t))
        : this.node().innerHTML;
    },
    raise: function () {
      return this.each(Tn);
      ...
      (n = he.exec(t))
        ? ((e = n[1].length),
          ...
          6 === e
            ...
            : null)
        : (n = de.exec(t))
        ? new Ee(n[1], n[2], n[3], 1)
        : (n = pe.exec(t))
        ? new Ee((255 * n[1]) / 100, (255 * n[2]) / 100, (255 * n[3]) / 100, 1)
        : (n = ge.exec(t))
        ? Ae(n[1], n[2], n[3], n[4])
        : (n = ye.exec(t))
        ? Ae((255 * n[1]) / 100, (255 * n[2]) / 100, (255 * n[3]) / 100, n[4])
        : (n = ve.exec(t))
        ? De(n[1], n[2] / 100, n[3] / 100, 1)
        : (n = _e.exec(t))
        ? De(n[1], n[2] / 100, n[3] / 100, n[4])
        : be.hasOwnProperty(t)
        ? Me(be[t])
        : "transparent" === t
        ? new Ee(NaN, NaN, NaN, 0)
        : null
    );
  }
  function Me(t) {
  ...
  function Te(t) {
    return (
      t instanceof ae || (t = we(t)),
      t ? new Ee((t = t.rgb()).r, t.g, t.b, t.opacity) : new Ee()
    );
  }
  function Se(t, n, e, r) {
  ...
  function Ne() {
    ...
    return `${
      1 === t ? "rgb(" : "rgba("
    }${Pe(this.r)}, ${Pe(this.g)}, ${Pe(this.b)}${1 === t ? ")" : `, ${t})`}`;
  }
  function Ce(t) {
  ...
  ie(ae, we, {
    ...
    ie(
      ...
      oe(ae, {
        brighter(t) {
          return (
            (t = null == t ? ce : Math.pow(ce, t)),
            new Ee(this.r * t, this.g * t, this.b * t, this.opacity)
          );
        },
        darker(t) {
          return (
    ...
    ie(
      ...
      oe(ae, {
        brighter(t) {
          return (
            (t = null == t ? ce : Math.pow(ce, t)),
            new qe(this.h, this.s, this.l * t, this.opacity)
          );
        },
        darker(t) {
          return (
  ...
  function Ge(t) {
    ...
    var n,
      ...
      i = Je(t.g),
      o = Je(t.b),
      a = Ze((0.2225045 * r + 0.7168786 * i + 0.0606169 * o) / 1);
    return (
      r === i && i === o
        ? (n = e = a)
        : ((n = Ze((0.4360747 * r + 0.3850649 * i + 0.1430804 * o) / Le)),
          (e = Ze((0.0139322 * r + 0.0971045 * i + 0.7141733 * o) / je))),
  ...
  function Ze(t) {
    return t > 0.008856451679035631 ? Math.pow(t, 1 / 3) : t / Xe + $e;
  }
  function Ke(t) {
  ...
  function tr(t) {
    ...
    if ((t instanceof We || (t = Ge(t)), 0 === t.a && 0 === t.b))
      return new er(NaN, 0 < t.l && t.l < 100 ? 0 : NaN, t.l, t.opacity);
    ...
    oe(ae, {
      ...
      rgb() {
        ...
        return new Ee(
          ...
          Qe(-0.9787684 * n + 1.9161415 * t + 0.033454 * e),
          Qe(0.0719453 * n - 0.2289914 * t + 1.4052427 * e),
          this.opacity
        );
      },
    })
  ...
  ie(
    ...
    oe(ae, {
      brighter(t) {
        return (
          (t = null == t ? ce : Math.pow(ce, t)),
          new pr(this.h, this.s, this.l * t, this.opacity)
        );
      },
      darker(t) {
        return (
  ...
  function mr(t, n) {
    var e = n - t;
    return e
      ? br(t, e > 180 || e < -180 ? e - 360 * Math.round(e / 360) : e)
      : _r(isNaN(t) ? n : t);
  }
  function xr(t) {
    return 1 == (t = +t)
  ...
  function Ar(t) {
    return function (n) {
      var e,
        ...
        u = new Array(i);
      for (e = 0; e < i; ++e)
        (r = Se(n[e])), (o[e] = r.r || 0), (a[e] = r.g || 0), (u[e] = r.b || 0);
      return (
        (o = t(o)),
        (a = t(a)),
        (u = t(u)),
  ...
  function Fr(t, n) {
    var e,
      r,
      i,
      o = (Dr.lastIndex = Rr.lastIndex = 0),
      a = -1,
      u = [],
      c = [];
    for (t += "", n += ""; (e = Dr.exec(t)) && (r = Rr.exec(n)); )
      (i = r.index) > o &&
        ...
        return null == t
          ...
          : (Ur ||
            ...
            (t = Ur.transform.baseVal.consolidate())
              ? Yr((t = t.matrix).a, t.b, t.c, t.d, t.e, t.f)
              : Br);
      },
      ", ",
      ")",
  ...
  function vi() {
    di(), ++oi;
    for (var t, n = ri; n; )
      (t = fi - n._time) >= 0 && n._call.call(void 0, t), (n = n._next);
    --oi;
  }
  function _i() {
  ...
  function mi(t) {
    oi ||
      ...
      t - fi > 24
        ? (t < 1 / 0 && (ai = setTimeout(_i, t - li.now() - si)),
          ui && (ui = clearInterval(ui)))
        : (ui || ((ci = li.now()), (ui = setInterval(bi, 1e3))),
          (oi = 1),
          hi(_i)));
  }
  function xi(t, n, e) {
  ...
  gi.prototype = yi.prototype = {
    ...
    restart: function (t, n, e) {
      ...
      (e = (null == e ? di() : +e) + (null == n ? 0 : +n)),
        this._next ||
          ii === this ||
          (ii ? (ii._next = this) : (ri = this), (ii = this)),
        (this._call = t),
        (this._time = e),
        mi();
    },
  ...
  eo.prototype = ro.prototype = {
    ...
    attr: function (t, n) {
      ...
      return this.attrTween(
        t,
        "function" == typeof n
          ? (e.local ? Ui : Oi)(e, r, Pi(this, "attr." + t, n))
          : null == n
          ? (e.local ? Ri : Di)(e)
          : (e.local ? qi : Fi)(e, r, n)
      );
        ...
        ? this.styleTween(
            ...
            (function (t, n, e) {
              ...
              return function () {
                ...
                return (
                  null == u &&
                    (this.style.removeProperty(t), (c = u = un(this, t))),
                  a === c
                    ? null
                    : a === r && c === i
                    ? o
    ...
    tween: function (t, n) {
      ...
      if (((t += ""), arguments.length < 2)) {
        for (
          var r, i = Ei(this.node(), e).tween, o = 0, a = i.length;
          o < a;
          ++o
        )
    ...
    delay: function (t) {
      var n = this._id;
      return arguments.length
        ? this.each(("function" == typeof t ? ji : $i)(n, t))
        : Ei(this.node(), n).delay;
    },
    duration: function (t) {
      var n = this._id;
      return arguments.length
        ? this.each(("function" == typeof t ? Hi : Xi)(n, t))
        : Ei(this.node(), n).duration;
    },
    ease: function (t) {
      var n = this._id;
  ...
  function mo(t) {
    return (t = +t) < _o
      ...
      ? bo * (t -= 0.5454545454545454) * t + 0.75
      : t < 0.9090909090909091
      ? bo * (t -= 0.8181818181818182) * t + 0.9375
      : bo * (t -= 0.9545454545454546) * t + 0.984375;
  }
  var xo = 1.70158,
    wo = (function t(n) {
      function e(t) {
    ...
    ko = (function t(n, e) {
      ...
      function i(t) {
        return (
          ((t = 2 * t - 1) < 0
            ? n * go(-t) * Math.sin((r - t) / e)
            : 2 - n * go(t) * Math.sin((r + t) / e)) / 2
        );
      }
      return (
        (i.amplitude = function (n) {
    ...
    No = { time: null, delay: 0, duration: 250, ease: uo };
  function Co(t, n) {
  ...
  (In.prototype.interrupt = function (t) {
    ...
    (In.prototype.transition = function (t) {
      ...
      t instanceof eo
        ? ((n = t._id), (t = t._name))
        : ((n = io()), ((e = No).time = di()), (t = null == t ? null : t + ""));
      for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
        for (var a, u = r[o], c = u.length, f = 0; f < c; ++f)
          (a = u[f]) && Ai(a, t, n, f, u, e || Co(a, n));
  ...
  var qo = { name: "drag" },
    ...
    Uo = { name: "handle" },
    Io = { name: "center" };
  const { abs: Bo, max: Yo, min: Lo } = Math;
  function jo(t) {
    return [+t[0], +t[1]];
  }
  function $o(t) {
  ...
  var Ho = {
    ...
    Zo = { n: "s", s: "n", nw: "sw", ne: "se", se: "ne", sw: "nw" },
    Ko = {
      overlay: 1,
      selection: 1,
      n: null,
  ...
  function oa(t) {
    ...
    function h(e) {
      if ((!n || e.touches) && r.apply(this, arguments)) {
        ...
        if ("overlay" === b) {
          ...
          (M.selection = T =
            [
              [
                (i = t === Xo ? S : Lo(n[0][0], n[1][0])),
                (u = t === Ho ? E : Lo(n[0][1], n[1][1])),
              ],
              [
                (l = t === Xo ? k : Yo(n[0][0], n[1][0])),
                (d = t === Ho ? N : Yo(n[0][1], n[1][1])),
              ],
            ]),
            D.length > 1 && I(e);
      ...
      function I(t) {
        ...
        switch (((C = n[0] - e[0]), (P = n[1] - e[1]), m)) {
          case Oo:
          case qo:
            x && ((C = Yo(S - i, Lo(k - l, C))), (a = i + C), (h = l + C)),
              w && ((P = Yo(E - u, Lo(N - d, P))), (c = u + P), (p = d + P));
            break;
          case Uo:
            D[1]
              ? (x &&
                ...
                w &&
                  ...
                  (w = 1)))
              : (x < 0
                  ? ((C = Yo(S - i, Lo(k - i, C))), (a = i + C), (h = l))
                  : x > 0 &&
                    ((C = Yo(S - l, Lo(k - l, C))), (a = i), (h = l + C)),
                w < 0
                  ? ((P = Yo(E - u, Lo(N - u, P))), (c = u + P), (p = d))
                  : w > 0 &&
                    ((P = Yo(E - d, Lo(N - d, P))), (c = u), (p = d + P)));
            break;
          case Io:
            x && ((a = Yo(S, Lo(k, i - C * x))), (h = Yo(S, Lo(k, l + C * x)))),
              w &&
                ((c = Yo(E, Lo(N, u - P * w))), (p = Yo(E, Lo(N, d + P * w))));
        }
        h < a &&
          ((x *= -1),
          (r = i),
          ...
          (a = h),
          (h = r),
          b in Wo && q.attr("cursor", Vo[(b = Wo[b])])),
          p < c &&
            ((w *= -1),
            (r = u),
            (u = d),
            ...
            (c = p),
            (p = r),
            b in Zo && q.attr("cursor", Vo[(b = Zo[b])])),
      ...
      function B(t) {
        ...
        F.attr("pointer-events", "all"),
          q.attr("cursor", Vo.overlay),
          M.selection && (T = M.selection),
          ia(T) && ((M.selection = null), f.call(_)),
          R.end(t, m.name);
      }
      function Y(t) {
        switch (t.keyCode) {
    ...
    return (
      ...
      (c.extent = function (t) {
        return arguments.length
          ? ((e = "function" == typeof t ? t : zo($o(t))), c)
          : e;
      }),
      (c.filter = function (t) {
        return arguments.length
          ? ((r = "function" == typeof t ? t : zo(!!t)), c)
          : r;
      }),
      (c.touchable = function (t) {
        return arguments.length
          ? ((i = "function" == typeof t ? t : zo(!!t)), c)
          : i;
      }),
  ...
  xa.prototype = wa.prototype = {
    ...
    arc: function (t, n, e, r, i, o) {
      ...
      null === this._x1
        ? (this._ += "M" + c + "," + f)
        : (Math.abs(this._x1 - c) > ba || Math.abs(this._y1 - f) > ba) &&
          (this._ += "L" + c + "," + f),
        e &&
          (l < 0 && (l = (l % _a) + _a),
          l > ma
      ...
      if (
        ...
        if (t) {
          var m = +t.apply(this, arguments),
            x = v - m,
            w = (_ + b) / 2;
          c.quadraticCurveTo(0, 0, x * ua(_), x * ca(_)),
            c.lineTo(v * ua(w), v * ca(w)),
            c.lineTo(x * ua(b), x * ca(b));
        } else
          c.quadraticCurveTo(0, 0, v * ua(_), v * ca(_)), c.arc(0, 0, v, _, b);
      if ((c.quadraticCurveTo(0, 0, p * ua(g), p * ca(g)), c.closePath(), f))
    ...
    return (
      t &&
        (f.headRadius = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : Aa(+n)), f)
            : t;
        }),
      (f.radius = function (t) {
        return arguments.length
          ? ((r = i = "function" == typeof t ? t : Aa(+t)), f)
          : r;
      }),
      (f.sourceRadius = function (t) {
        return arguments.length
          ? ((r = "function" == typeof t ? t : Aa(+t)), f)
          : r;
      }),
      (f.targetRadius = function (t) {
        return arguments.length
          ? ((i = "function" == typeof t ? t : Aa(+t)), f)
          : i;
      }),
      (f.startAngle = function (t) {
        return arguments.length
          ? ((o = "function" == typeof t ? t : Aa(+t)), f)
          : o;
      }),
      (f.endAngle = function (t) {
        return arguments.length
          ? ((a = "function" == typeof t ? t : Aa(+t)), f)
          : a;
      }),
      (f.padAngle = function (t) {
        return arguments.length
          ? ((u = "function" == typeof t ? t : Aa(+t)), f)
          : u;
      }),
      (f.source = function (t) {
    ...
    function o(e, i) {
      ...
      return (
        (function (e, r, i) {
          ...
          for (; ++o < t - 1; )
            (c = f), (f = e[o + 1] >= r), Ba[c | (f << 1)].forEach(p);
          Ba[f << 0].forEach(p);
          for (; ++u < n - 1; ) {
            for (
              o = -1,
  ...
  class iu {
    ...
    update() {
      ...
      for (let n = 0; n < o; n++)
        this._dists[n] = ou(t[2 * n], t[2 * n + 1], M.x, M.y);
      ...
      for (let o, a, u = 0; u < this._ids.length; u++) {
        ...
        for (
          ;
          (g = e[y]),
            nu(f, s, t[2 * y], t[2 * y + 1], t[2 * g], t[2 * g + 1]) >= 0;
        ...
        for (
          ;
          (g = e[_]),
            nu(f, s, t[2 * _], t[2 * _ + 1], t[2 * g], t[2 * g + 1]) < 0;
        ...
        if (y === l)
          for (
            ;
            (g = n[y]),
              nu(f, s, t[2 * g], t[2 * g + 1], t[2 * y], t[2 * y + 1]) < 0;
  ...
  function cu(t, n, e, r) {
    if (r - e <= 20)
      ...
      let i = e + 1,
        o = r;
      fu(t, (e + r) >> 1, i),
        n[t[e]] > n[t[r]] && fu(t, e, r),
        n[t[i]] > n[t[r]] && fu(t, i, r),
        n[t[e]] > n[t[i]] && fu(t, e, i);
      const a = t[i],
        u = n[a];
      for (;;) {
        do {
  ...
  class du {
    ...
    arc(t, n, e) {
      ...
      null === this._x1
        ? (this._ += `M${r},${i}`)
        : (Math.abs(this._x1 - r) > hu || Math.abs(this._y1 - i) > hu) &&
          (this._ += "L" + r + "," + i),
        e &&
          (this._ += `A${e},${e},0,1,1,${
            t - e
    ...
    _step(t, n, e) {
      ...
      do {
        ...
        if (((h = a[h]), -1 === h)) {
          if (
            ((h = i[(o[t] + 1) % i.length]),
            h !== r && vu(n - c[2 * h], 2) + vu(e - c[2 * h + 1], 2) < s)
          )
            return h;
          break;
        }
  ...
  function tc(t) {
    return (n, e) =>
      Wu(n, e).then((n) => new DOMParser().parseFromString(n, t));
  }
  ...
  (lc.copy = function () {
    var t,
      n,
      e = new fc(this._x, this._y, this._x0, this._y0, this._x1, this._y1),
      r = this._root;
    if (!r) return e;
    ...
    (lc.visit = function (t) {
      var n,
        ...
        c = this._root;
      for (
        c && u.push(new oc(c, this._x0, this._y0, this._x1, this._y1));
        (n = u.pop());
        ...
        if (
          ...
          var f = (r + o) / 2,
            s = (i + a) / 2;
          (e = c[3]) && u.push(new oc(e, f, s, o, a)),
            (e = c[2]) && u.push(new oc(e, r, s, f, a)),
            (e = c[1]) && u.push(new oc(e, f, i, o, s)),
            (e = c[0]) && u.push(new oc(e, r, i, f, s));
        }
      return this;
    }),
    (lc.visitAfter = function (t) {
      ...
      for (
        this._root &&
        e.push(new oc(this._root, this._x0, this._y0, this._x1, this._y1));
        (n = e.pop());
        ...
        if (i.length) {
          var o,
            ...
            s = (a + c) / 2,
            l = (u + f) / 2;
          (o = i[0]) && e.push(new oc(o, a, u, s, l)),
            (o = i[1]) && e.push(new oc(o, s, u, c, l)),
            (o = i[2]) && e.push(new oc(o, a, l, s, f)),
            (o = i[3]) && e.push(new oc(o, s, l, c, f));
        }
        r.push(n);
      }
  ...
  function Fc(n) {
    return (
      (Pc = Rc(n)),
      (t.format = Pc.format),
      (t.formatPrefix = Pc.formatPrefix),
      Pc
    );
  }
  function qc(t) {
  ...
  function Oc(t, n) {
    return Math.max(
      0,
      3 * Math.max(-8, Math.min(8, Math.floor(Mc(n) / 3))) - Mc(Math.abs(t))
    );
  }
  function Uc(t, n) {
    return (
      (t = Math.abs(t)), (n = Math.abs(n) - t), Math.max(0, Mc(n) - Mc(t)) + 1
    );
  }
  (t.format = void 0),
    (t.formatPrefix = void 0),
    Fc({ thousands: ",", grouping: [3], currency: ["$", ""] });
  var Ic = 1e-6,
    Bc = 1e-12,
    Yc = Math.PI,
    Lc = Yc / 2,
  ...
  var vf,
    ...
    Ff = {
      ...
      polygonEnd: function () {
        var t = +Df;
        Rf.add(t < 0 ? $c + t : t),
          (this.lineStart = this.lineEnd = this.point = sf);
      },
      sphere: function () {
        Rf.add($c);
      },
  ...
  function ls(t, n) {
    ...
    if (Nf) {
      ...
      f ^ (u * Sf < c && c < u * t)
        ? (o = i[1] * Hc) > Tf && (Tf = o)
        : f ^ (u * Sf < (c = ((c + 360) % 360) - 180) && c < u * t)
        ? (o = -i[1] * Hc) < Mf && (Mf = o)
        : (n < Mf && (Mf = n), n > Tf && (Tf = n)),
        f
          ? t < Sf
            ? vs(wf, t) > vs(wf, Af) && (Af = t)
            : vs(t, Af) > vs(wf, Af) && (wf = t)
          : Af >= wf
          ? (t < wf && (wf = t), t > Af && (Af = t))
          : t > Sf
          ? vs(wf, t) > vs(wf, Af) && (Af = t)
  ...
  function Us(t) {
    ...
    return (
      (t = Rs(t[0] * Xc, t[1] * Xc, t.length > 2 ? t[2] * Xc : 0)),
      (n.invert = function (n) {
  ...
  function Is(t, n, e, r, i, o) {
    if (e) {
      ...
      for (var f, s = i; r > 0 ? s > o : s < o; s -= c)
        (f = Bf([a, -u * Zc(s), -u * ef(s)])), t.point(f[0], f[1]);
    }
  }
  function Bs(t, n) {
    ((n = Yf(n))[0] -= t), Xf(n);
    ...
    if (
      (t.forEach(function (t) {
        if (!((n = t.length - 1) <= 0)) {
          ...
          u.push((e = new js(r, t, null, !0))),
            c.push((e.o = new js(r, null, e, !1))),
            u.push((e = new js(a, t, null, !1))),
            c.push((e.o = new js(a, null, e, !0)));
        }
      }),
      u.length)
    ) {
      for (c.sort(n), Hs(u), Hs(c), o = 0, a = c.length; o < a; ++o)
        c[o].e = e = !e;
      for (var f, s, l = u[0]; ; ) {
      ...
      var o,
        ...
        h = {
          ...
          polygonEnd: function () {
            ...
            var t = Gs(o, r);
            a.length
              ? (l || (i.polygonStart(), (l = !0)), $s(a, Zs, t, e, i))
              : t &&
  ...
  function Zs(t, n) {
    return (
      ((t = t.x)[0] < 0 ? t[1] - Lc - Ic : Lc - t[1]) -
      ((n = n.x)[0] < 0 ? n[1] - Lc - Ic : Lc - n[1])
    );
  }
  Ds.invert = Ds;
  var Ks = Vs(
      ...
      function (t) {
        ...
        return {
          ...
          point: function (l, h) {
            ...
            if (
              (!n && (f = c = g) && t.lineStart(),
              g !== c && (!(d = a(n, p)) || Ls(n, d) || Ls(p, d)) && (p[2] = 1),
              g !== c)
            )
              (s = 0),
                g
    ...
    return function (a) {
      ...
      function M(o, a) {
        ...
        if ((f && s.push([o, a]), v))
          ...
          var c = [
              (p = Math.max(il, Math.min(rl, p))),
              (g = Math.max(il, Math.min(rl, g))),
            ],
            m = [
              (o = Math.max(il, Math.min(rl, o))),
              (a = Math.max(il, Math.min(rl, a))),
            ];
  ...
  var ll = [null, null],
    hl = { type: "LineString", coordinates: ll };
  function dl(t, n) {
  ...
  function Al() {
    ...
    function _() {
      return et(Kc(r / p) * p, e, p)
        .map(s)
        .concat(et(Kc(u / g) * g, a, g).map(l))
        .concat(
          et(Kc(n / h) * h, t, h)
            .filter(function (t) {
              return Gc(t % p) > Ic;
  ...
  var Tl,
    ...
    zl = {
      ...
      polygonEnd: function () {
        (zl.lineStart = zl.lineEnd = zl.point = sf),
          Cl.add(Gc(Pl)),
          (Pl = new _());
      },
      result: function () {
      ...
      switch (this._point) {
        ...
        default:
          this._context.moveTo(t + this._radius, n),
            this._context.arc(t, n, this._radius, 0, $c);
      }
    },
    result: sf,
  };
    ...
    point: function (t, n) {
      switch (this._point) {
        ...
        case 1:
          ...
          break;
        default:
          null == this._circle && (this._circle = Sh(this._radius)),
          ...
          function e(r, i, o, a, u, c, f, s, l, h, d, p, g, y) {
            ...
            if (b > 4 * n && g--) {
              var m = a + h,
                ...
                A = cf((w /= M)),
                T =
                  Gc(Gc(w) - 1) < Ic || Gc(o - l) < Ic ? (o + l) / 2 : Wc(x, m),
                S = t(T, A),
                E = S[0],
                k = S[1],
                N = E - r,
  ...
  function Ih(t) {
    ...
    function N() {
      ...
      return (
        (e = Rs(y, v, _)), (u = zs(n, r)), (c = zs(e, u)), (a = Fh(u, S)), C()
      );
    }
    function C() {
      return (f = s = null), E;
    ...
    return (
      (a.invert = function (t, n) {
        var e = o - n,
          a = Wc(t, Gc(e)) * rf(e);
        return (
          e * r < 0 && (a -= Yc * rf(t) * rf(e)),
          [a / r, cf((i - (t * t + e * e) * r * r) / (2 * r))]
        );
      }),
      a
    );
    ...
    return (
      (o.invert = function (t, n) {
        var e = i - n,
          o = Wc(t, Gc(e)) * rf(e);
        return (
          e * r < 0 && (o -= Yc * rf(t) * rf(e)),
          [o / r, i - rf(r) * of(t * t + e * e)]
        );
      }),
      o
    );
  ...
  function od(t, n) {
    var e = cf(id * ef(n)),
      ...
      i = r * r * r;
    return [
      (t * Zc(e)) / (id * (td + 3 * nd * r + i * (7 * ed + 9 * rd * r))),
      e * (td + nd * r + i * (ed + rd * r)),
    ];
  }
  function ad(t, n) {
  ...
  (od.invert = function (t, n) {
    for (
      ...
      ((o =
        (i =
          (r -= e =
            (r * (td + nd * i + o * (ed + rd * i)) - n) /
            (td + 3 * nd * i + o * (7 * ed + 9 * rd * i))) * r) *
        i *
        i),
      !(Gc(e) < Bc));
      ++a
    ...
    return [
      (id * t * (td + 3 * nd * i + o * (7 * ed + 9 * rd * i))) / Zc(r),
      cf(ef(r) / id),
    ];
  }),
    (ad.invert = Hh(Vc)),
  ...
  function Ed(t, n) {
    for (
      ...
      (e = t[i]), r && Cd(r, e) ? ++i : ((r = zd((a = kd(a, e)))), (i = 0));
    return r;
  }
  function kd(t, n) {
    var e, r;
  ...
  function Pd(t, n) {
    for (var e = 0; e < n.length; ++e) if (!Cd(t, n[e])) return !1;
    return !0;
  }
  function zd(t) {
    switch (t.length) {
  ...
  function Id(t, n) {
    ...
    t: for (c = 3; c < o; ++c) {
      ...
      for (
        i.previous = e, i.next = r, e.next = r.previous = r = i, a = Od(e);
        (i = i.next) !== r;
  ...
  function Ld(t, n, e) {
    return function (r) {
      if ((i = r.children)) {
        ...
        if (((a = Id(i, e)), c)) for (o = 0; o < u; ++o) i[o].r -= c;
        r.r = a + c;
      }
    };
  }
      ...
      if ((a = t._squarify) && a.ratio === n)
        for (var a, u, c, f, s, l = -1, h = a.length, d = t.value; ++l < h; ) {
          for (
            ...
            u.value += c[f].value;
          u.dice
            ? Hd(u, e, r, i, d ? (r += ((o - r) * u.value) / d) : o)
  ...
  function Lp(t, n, e) {
    var r = t[0],
      ...
      a = n[1];
    return (
      i < r ? ((r = Yp(i, r)), (o = e(a, o))) : ((r = Yp(r, i)), (o = e(o, a))),
      function (t) {
        return o(r(t));
      }
    );
  ...
  function jp(t, n, e) {
    ...
    for (
      ...
      (i[a] = Yp(t[a], t[a + 1])), (o[a] = e(n[a], n[a + 1]));
    return function (n) {
      var e = s(t, n, 1, r) - 1;
      return o[e](i[e](n));
    };
  ...
  function Gp(n, e, r, i) {
    ...
    switch ((i = Sc(null == i ? ",f" : i)).type) {
      case "s":
        ...
        return (
          null != i.precision || isNaN((o = Oc(a, u))) || (i.precision = o),
          t.formatPrefix(i, u)
        );
      case "":
      case "e":
      ...
      case "r":
        null != i.precision ||
          isNaN((o = Uc(a, Math.max(Math.abs(n), Math.abs(e))))) ||
  ...
  function eg(n) {
    ...
    function u() {
      return (
        ...
        r()[0] < 0 ? ((i = ng(i)), (o = ng(o)), n(Qp, Jp)) : n(Zp, Kp),
        e
      );
    }
    return (
      ...
      (e.tickFormat = (n, r) => {
        if (
          ...
          null == r && (r = 10 === a ? "s" : ","),
          "function" != typeof r &&
            (a % 1 || null != (r = Sc(r)).precision || (r.trim = !0),
            (r = t.format(r))),
          n === 1 / 0)
        )
          return r;
  ...
  function fg(t) {
    var n = t(Bp, Bp),
      e = 1;
    function r() {
      return 1 === e ? t(Bp, Bp) : 0.5 === e ? t(ug, cg) : t(ag(e), ag(1 / e));
    }
    return (
    ...
    return (
      ...
      e &&
        ((i.count = function (n, r) {
          return (
            dg.setTime(+n), pg.setTime(+r), t(dg), t(pg), Math.floor(e(dg, pg))
          );
        }),
        (i.every = function (t) {
          return (
  ...
  var Sg = gg(
    ...
    zg = gg(
      function (t) {
        t.setTime(
          t - t.getMilliseconds() - t.getSeconds() * bg - t.getMinutes() * mg
        );
      },
      function (t, n) {
        t.setTime(+t + n * xg);
    ...
    Fg = gg(
      ...
      (t, n) =>
        (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * mg) / wg,
      (t) => t.getDate() - 1
    ),
    qg = Fg,
    Og = Fg.range;
  function Ug(t) {
    return gg(
      ...
      function (t, n) {
        return (
          (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * mg) / Mg
        );
      }
    );
  }
  ...
  const [qy, Oy] = Fy(Dy, Cy, gy, hy, fy, ay),
    [Uy, Iy] = Fy(ry, ty, Ig, qg, Dg, Cg);
  function By(t) {
    if (0 <= t.y && t.y < 100) {
    ...
    function M(t, n) {
      return function (e) {
        ...
        if (
          ...
          "w" in o || (o.w = 1),
            "Z" in o
              ? ((i = (r = Yy(Ly(o.y, 0, 1))).getUTCDay()),
                (r = i > 4 || 0 === i ? yy.ceil(r) : yy(r)),
                (r = hy.offset(r, 7 * (o.V - 1))),
                (o.y = r.getUTCFullYear()),
                (o.m = r.getUTCMonth()),
                (o.d = r.getUTCDate() + ((o.w + 6) % 7)))
              : ((i = (r = By(Ly(o.y, 0, 1))).getDay()),
                (r = i > 4 || 0 === i ? Bg.ceil(r) : Bg(r)),
                (r = qg.offset(r, 7 * (o.V - 1))),
                (o.y = r.getFullYear()),
                (o.m = r.getMonth()),
        ...
        return "Z" in o
          ? ((o.H += (o.Z / 100) | 0), (o.M += o.Z % 100), Yy(o))
          : By(o);
      };
    }
    function A(t, n, e, r) {
      for (var i, o, a = 0, u = n.length, c = e.length; a < u; ) {
        ...
        if (37 === (i = n.charCodeAt(a++))) {
          if (
            ((i = n.charAt(a++)),
            !(o = x[i in Hy ? n.charAt(a++) : i]) || (r = o(t, e, r)) < 0)
          )
            return -1;
  ...
  function Ov(t, n) {
    var e = t.getDay();
    return Wy(
      (t = e >= 4 || 0 === e ? jg(t) : jg.ceil(t)).getFullYear() % 1e4,
      n,
      4
    );
  }
  ...
  function Kv(t, n) {
    return (
      (t = Zv(t)), Wy(by.count(Dy(t), t) + (4 === Dy(t).getUTCDay()), n, 2)
    );
  }
  function Qv(t) {
    return t.getUTCDay();
  ...
  function c_(n) {
    return (
      ($y = jy(n)),
      (t.timeFormat = $y.format),
      (t.timeParse = $y.parse),
      (t.utcFormat = $y.utcFormat),
      (t.utcParse = $y.utcParse),
      $y
    );
  }
  (t.timeFormat = void 0),
  ...
  var s_ = Date.prototype.toISOString
      ...
      : t.utcFormat(f_),
    l_ = s_;
  var h_ = +new Date("2000-01-01T00:00:00.000Z")
      ? function (t) {
          var n = new Date(t);
  ...
  var M_ = w_("1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf"),
    ...
    zb = new Array(3)
      ...
      .map(w_),
    Db = D_(zb);
  var Rb = ni(dr(300, 0.5, 0), dr(-240, 0.5, 1)),
    Fb = ni(dr(-100, 0.75, 0.35), dr(80, 1.5, 0.8)),
    qb = ni(dr(260, 0.75, 0.35), dr(80, 1.5, 0.8)),
    Ob = dr();
  var Ub = Se(),
    Ib = Math.PI / 3,
    Bb = (2 * Math.PI) / 3;
  ...
  function bm(t, n) {
    ...
    return (
      (t = "function" == typeof t ? t : void 0 === t ? vm : Xb(t)),
      (n = "function" == typeof n ? n : void 0 === n ? _m : Xb(n)),
      (a.x = function (n) {
        return arguments.length
          ? ((t = "function" == typeof n ? n : Xb(+n)), a)
          : t;
      }),
      (a.y = function (t) {
        return arguments.length
          ? ((n = "function" == typeof t ? t : Xb(+t)), a)
          : n;
      }),
      (a.defined = function (t) {
        return arguments.length
          ? ((e = "function" == typeof t ? t : Xb(!!t)), a)
          : e;
      }),
      (a.curve = function (t) {
  ...
  function mm(t, n, e) {
    ...
    return (
      (t = "function" == typeof t ? t : void 0 === t ? vm : Xb(+t)),
      (n = "function" == typeof n ? n : Xb(void 0 === n ? 0 : +n)),
      (e = "function" == typeof e ? e : void 0 === e ? _m : Xb(+e)),
      (c.x = function (n) {
        return arguments.length
          ? ((t = "function" == typeof n ? n : Xb(+n)), (r = null), c)
          : t;
      }),
      (c.x0 = function (n) {
        return arguments.length
          ? ((t = "function" == typeof n ? n : Xb(+n)), c)
          : t;
      }),
      (c.x1 = function (t) {
        return arguments.length
          ? ((r = null == t ? null : "function" == typeof t ? t : Xb(+t)), c)
          : r;
      }),
      (c.y = function (t) {
        return arguments.length
          ? ((n = "function" == typeof t ? t : Xb(+t)), (e = null), c)
          : n;
      }),
      (c.y0 = function (t) {
        return arguments.length
          ? ((n = "function" == typeof t ? t : Xb(+t)), c)
          : n;
      }),
      (c.y1 = function (t) {
        return arguments.length
          ? ((e = null == t ? null : "function" == typeof t ? t : Xb(+t)), c)
          : e;
      }),
      (c.lineX0 = c.lineY0 =
        function () {
  ...
  function Om(t) {
    ...
    return (
      ...
      (u.x = function (t) {
        return arguments.length
          ? ((r = "function" == typeof t ? t : Xb(+t)), u)
          : r;
      }),
      (u.y = function (t) {
        return arguments.length
          ? ((i = "function" == typeof t ? t : Xb(+t)), u)
          : i;
      }),
  ...
  var Im = {
      draw(t, n) {
        const e = 0.59436 * Jb(n + Kb(n / 28, 0.75)),
          r = e / 2,
          i = r * Um;
        t.moveTo(0, e),
          t.lineTo(0, -e),
  ...
  var Qm = {
    draw(t, n) {
      const e = Jb(0.8908130915292852 * n),
        r = Zm * e,
        i = Km * e;
  ...
  var ux = {
      draw(t, n) {
        ...
        t.moveTo(r, i),
          t.lineTo(o, a),
          t.lineTo(u, c),
          t.lineTo(rx * r - ix * i, ix * r + rx * i),
          t.lineTo(rx * o - ix * a, ix * o + rx * a),
          t.lineTo(rx * u - ix * c, ix * u + rx * c),
          t.lineTo(rx * r + ix * i, rx * i - ix * r),
          t.lineTo(rx * o + ix * a, rx * a - ix * o),
          t.lineTo(rx * u + ix * c, rx * c - ix * u),
          t.closePath();
      },
    },
    cx = {
      draw(t, n) {
        const e = 0.6189 * Jb(n - Kb(n / 6, 1.7));
  ...
  function Rx(t, n, e) {
    var r = t._x1 - t._x0,
      ...
      u = (o * i + a * r) / (r + i);
    return (
      (Dx(o) + Dx(a)) * Math.min(Math.abs(o), Math.abs(a), 0.5 * Math.abs(u)) ||
      0
    );
  }
  function Fx(t, n) {
      ...
      lineEnd: function () {
        ...
        if (e)
          if (
            ...
            for (var r = Yx(t), i = Yx(n), o = 0, a = 1; a < e; ++o, ++a)
              this._context.bezierCurveTo(
                r[0][o],
                i[0][o],
                r[1][o],
  ...
  var Kx = (t) => () => t;
  function Qx(t, { sourceEvent: n, target: e, transform: r, dispatch: i }) {
    Object.defineProperties(this, {
      type: { value: t, enumerable: !0, configurable: !0 },
      sourceEvent: { value: n, enumerable: !0, configurable: !0 },
      target: { value: e, enumerable: !0, configurable: !0 },
  ...
  Jx.prototype = {
    ...
    translate: function (t, n) {
      return (0 === t) & (0 === n)
        ? this
        : new Jx(this.k, this.x + this.k * t, this.y + this.k * n);
    },
    apply: function (t) {
  ...
  var tw = new Jx(1, 0, 0);
  function nw(t) {
    for (; !t.__zoom; ) if (!(t = t.parentNode)) return tw;
    return t.__zoom;
  }
  function ew(t) {
    t.stopImmediatePropagation();
  ...
  (nw.prototype = Jx.prototype),
    (t.Adder = _),
    (t.Delaunay = xu),
    (t.FormatSpecifier = Ec),
    ...
    (t.arc = function () {
      ...
      function c() {
        ...
        if ((u || (u = c = wa()), l < s && ((f = l), (l = s), (s = f)), l > tm))
          if (p > rm - tm)
            u.moveTo(l * Wb(h), l * Qb(h)),
              u.arc(0, 0, l, h, d, !g),
              s > tm &&
                (u.moveTo(s * Wb(d), s * Qb(d)), u.arc(0, 0, s, d, h, g));
          else {
            var y,
              v,
              _ = h,
      ...
      return (
        ...
        (c.endAngle = function (t) {
          return arguments.length
            ? ((o = "function" == typeof t ? t : Xb(+t)), c)
            : o;
        }),
        (c.padAngle = function (t) {
          return arguments.length
            ? ((a = "function" == typeof t ? t : Xb(+t)), c)
            : a;
        }),
        (c.context = function (t) {
        ...
        if (i)
          if ("true" === i) i = !0;
            ...
            if (
              ...
              continue;
            Hu && r[4] && !r[7] && (i = i.replace(/-/g, "/").replace(/T/, " ")),
              (i = new Date(i));
          } else i = e;
        else i = null;
        t[n] = i;
    ...
    (t.contourDensity = function () {
      ...
      return (
        (l.x = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : Fa(+n)), l)
            : t;
        }),
        (l.y = function (t) {
          return arguments.length
            ? ((n = "function" == typeof t ? t : Fa(+t)), l)
            : n;
        }),
        (l.weight = function (t) {
          return arguments.length
            ? ((e = "function" == typeof t ? t : Fa(+t)), l)
            : e;
        }),
        (l.size = function (t) {
    ...
    (t.curveBundle = vx),
    (t.curveCardinal = mx),
    (t.curveCardinalClosed = wx),
    (t.curveCardinalOpen = Ax),
    (t.curveCatmullRom = Ex),
    (t.curveCatmullRomClosed = Nx),
    (t.curveCatmullRomOpen = Px),
    (t.curveLinear = ym),
    ...
    (t.drag = function () {
      ...
      function d(a, u) {
        if (!r && i.call(this, a, u)) {
          ...
          c &&
            (Bn(a.view).on("mousemove.drag", p, Gn).on("mouseup.drag", g, Gn),
            Zn(a.view),
            Vn(a),
            (e = !1),
            (t = a.clientX),
      ...
      function v(t) {
        var n,
          ...
          i = r.length;
        for (n = 0; n < i; ++n)
          (e = c[r[n].identifier]) && (Wn(t), e("drag", t, r[n]));
      }
      function _(t) {
        var n,
          e,
      ...
      return (
        (h.filter = function (t) {
          return arguments.length
            ? ((i = "function" == typeof t ? t : Qn(!!t)), h)
            : i;
        }),
        (h.container = function (t) {
          return arguments.length
            ? ((o = "function" == typeof t ? t : Qn(t)), h)
            : o;
        }),
        (h.subject = function (t) {
          return arguments.length
            ? ((a = "function" == typeof t ? t : Qn(t)), h)
            : a;
        }),
        (h.touchable = function (t) {
          return arguments.length
            ? ((u = "function" == typeof t ? t : Qn(!!t)), h)
            : u;
        }),
        (h.on = function () {
    ...
    (t.forceCollide = function (t) {
      ...
      function a() {
        for (var t, a, c, f, s, l, h, d = n.length, p = 0; p < o; ++p)
          for (a = cc(n, pc, gc).visitAfter(u), t = 0; t < d; ++t)
            (c = n[t]),
              (l = e[c.index]),
              (h = l * l),
              (f = c.x + c.vx),
      ...
      return (
        "function" != typeof t && (t = hc(null == t ? 1 : +t)),
        ...
        (a.radius = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : hc(+n)), c(), a)
            : t;
        }),
        a
      );
    ...
    (t.forceLink = function (t) {
      ...
      function l(r) {
        for (var i = 0, u = t.length; i < s; ++i)
          for (var c, f, l, h, d, p, g, y = 0; y < u; ++y)
            (f = (c = t[y]).source),
              (h = (l = c.target).x + l.vx - f.x - f.vx || dc(a)),
              (d = l.y + l.vy - f.y - f.vy || dc(a)),
              (h *= p =
      ...
      function h() {
        if (r) {
          ...
          for (a = 0, i = new Array(f); a < s; ++a)
            ((c = t[a]).index = a),
              "object" != typeof c.source && (c.source = vc(l, c.source)),
              "object" != typeof c.target && (c.target = vc(l, c.target)),
      ...
      return (
        ...
        (l.strength = function (t) {
          return arguments.length
            ? ((c = "function" == typeof t ? t : hc(+t)), d(), l)
            : c;
        }),
        (l.distance = function (t) {
          return arguments.length
            ? ((f = "function" == typeof t ? t : hc(+t)), p(), l)
            : f;
        }),
        l
      );
    ...
    (t.forceManyBody = function () {
      ...
      return (
        ...
        (f.strength = function (t) {
          return arguments.length
            ? ((o = "function" == typeof t ? t : hc(+t)), s(), f)
            : o;
        }),
    ...
    (t.forceRadial = function (t, n, e) {
      ...
      return (
        ...
        (u.strength = function (t) {
          return arguments.length
            ? ((a = "function" == typeof t ? t : hc(+t)), c(), u)
            : a;
        }),
        (u.radius = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : hc(+n)), c(), u)
            : t;
        }),
        (u.x = function (t) {
          return arguments.length ? ((n = +t), u) : n;
    ...
    (t.forceX = function (t) {
      ...
      return (
        "function" != typeof t && (t = hc(null == t ? 0 : +t)),
        (o.initialize = function (t) {
          (n = t), a();
        }),
        (o.strength = function (t) {
          return arguments.length
            ? ((i = "function" == typeof t ? t : hc(+t)), a(), o)
            : i;
        }),
        (o.x = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : hc(+n)), a(), o)
            : t;
        }),
        o
      );
    ...
    (t.formatDefaultLocale = Fc),
    (t.formatLocale = Rc),
    (t.formatSpecifier = Sc),
    (t.fsum = function (t, n) {
      const e = new _();
        ...
        (s.translate = function (t) {
          ...
          return (
            ...
            (r = u
              ...
              .clipExtent([
                [o - 0.425 * n + Ic, s + 0.12 * n + Ic],
                [o - 0.214 * n - Ic, s + 0.234 * n - Ic],
              ])
              .stream(f)),
            (i = c
              .translate([o - 0.205 * n, s + 0.212 * n])
              .clipExtent([
                [o - 0.214 * n + Ic, s + 0.166 * n + Ic],
                [o - 0.115 * n - Ic, s + 0.234 * n - Ic],
              ])
              .stream(f)),
            l()
          );
    ...
    (t.geoAzimuthalEqualAreaRaw = Xh),
    (t.geoAzimuthalEquidistant = function () {
      return Uh(Gh).scale(79.4188).clipAngle(179.999);
    }),
    (t.geoAzimuthalEquidistantRaw = Gh),
    (t.geoBounds = function (t) {
      var n, e, r, i, o, a, u;
      if (
        ((Tf = Af = -(wf = Mf = 1 / 0)), (Pf = []), yf(t, fs), (e = Pf.length))
      ) {
        for (Pf.sort(_s), n = 1, o = [(r = Pf[0])]; n < e; ++n)
          bs(r, (i = Pf[n])[0]) || bs(r, i[1])
            ? (vs(r[0], i[1]) > vs(r[0], r[1]) && (r[1] = i[1]),
              vs(i[0], r[1]) > vs(r[0], r[1]) && (r[0] = i[0]))
            : o.push((r = i));
        for (a = -1 / 0, n = 0, r = o[(e = o.length - 1)]; n <= e; r = i, ++n)
          (i = o[n]),
            (u = vs(r[1], i[0])) > a && ((a = u), (wf = i[0]), (Af = r[1]));
      }
      return (
        (Pf = zf = null),
        wf === 1 / 0 || Mf === 1 / 0
    ...
    (t.geoCircle = function () {
      ...
      return (
        (a.center = function (t) {
          return arguments.length
            ? ((e = "function" == typeof t ? t : Ps([+t[0], +t[1]])), a)
            : e;
        }),
        (a.radius = function (t) {
          return arguments.length
            ? ((r = "function" == typeof t ? t : Ps(+t)), a)
            : r;
        }),
        (a.precision = function (t) {
          return arguments.length
            ? ((i = "function" == typeof t ? t : Ps(+t)), a)
            : i;
        }),
        a
      );
    }),
    (t.geoClipAntimeridian = Ks),
    (t.geoClipCircle = Qs),
    ...
    (t.geoPath = function (t, n) {
      ...
      return (
        ...
        (o.projection = function (n) {
          return arguments.length
            ? ((e = null == n ? ((t = null), Nl) : (t = n).stream), o)
            : t;
        }),
        (o.context = function (t) {
          return arguments.length
            ? ((r = null == t ? ((n = null), new Th()) : new ph((n = t))),
    ...
    (t.interpolateBasis = yr),
    (t.interpolateBasisClosed = vr),
    (t.interpolateBlues = Mb),
    (t.interpolateBrBG = F_),
    (t.interpolateBuGn = J_),
    (t.interpolateBuPu = nb),
    ...
    (t.interpolateCool = qb),
    (t.interpolateCubehelix = ti),
    (t.interpolateCubehelixDefault = Rb),
    (t.interpolateCubehelixLong = ni),
    (t.interpolateDate = Cr),
    ...
    (t.interpolateGnBu = rb),
    (t.interpolateGreens = Tb),
    (t.interpolateGreys = Eb),
    (t.interpolateHcl = Kr),
    (t.interpolateHclLong = Qr),
    (t.interpolateHsl = Vr),
    ...
    (t.interpolateMagma = jb),
    (t.interpolateNumber = Pr),
    (t.interpolateNumberArray = Er),
    (t.interpolateObject = zr),
    (t.interpolateOrRd = ob),
    (t.interpolateOranges = Db),
    (t.interpolatePRGn = O_),
    (t.interpolatePiYG = I_),
    (t.interpolatePlasma = Hb),
    (t.interpolatePuBu = fb),
    (t.interpolatePuBuGn = ub),
    (t.interpolatePuOr = Y_),
    (t.interpolatePuRd = lb),
    (t.interpolatePurples = Nb),
    ...
    (t.interpolateRdBu = j_),
    (t.interpolateRdGy = H_),
    (t.interpolateRdPu = db),
    (t.interpolateRdYlBu = G_),
    (t.interpolateRdYlGn = W_),
    (t.interpolateReds = Pb),
    (t.interpolateRgb = Mr),
    (t.interpolateRgbBasis = Tr),
    (t.interpolateRgbBasisClosed = Sr),
    (t.interpolateRound = Or),
    (t.interpolateSinebow = function (t) {
      var n;
      return (
        (t = (0.5 - t) * Math.PI),
        (Ub.r = 255 * (n = Math.sin(t)) * n),
        (Ub.g = 255 * (n = Math.sin(t + Ib)) * n),
        (Ub.b = 255 * (n = Math.sin(t + Bb)) * n),
        Ub + ""
      );
    }),
    (t.interpolateSpectral = K_),
    (t.interpolateString = Fr),
    (t.interpolateTransformCss = jr),
    ...
    (t.interpolateWarm = Fb),
    (t.interpolateYlGn = vb),
    (t.interpolateYlGnBu = gb),
    (t.interpolateYlOrBr = bb),
    (t.interpolateYlOrRd = xb),
    (t.interpolateZoom = Xr),
    (t.interrupt = ki),
    ...
    (t.pack = function () {
      ...
      function i(i) {
        ...
        return (
          ...
          (i.y = e / 2),
          t
            ? i.eachBefore(Yd(t)).eachAfter(Ld(r, 0.5, o)).eachBefore(jd(1))
            : i
                .eachBefore(Yd(Bd))
                .eachAfter(Ld(Md, 1, o))
                .eachAfter(Ld(r, i.r / Math.min(n, e), o))
                .eachBefore(jd(Math.min(n, e) / (2 * i.r))),
          i
        );
      }
      return (
    ...
    (t.pie = function () {
      ...
      return (
        ...
        (a.startAngle = function (t) {
          return arguments.length
            ? ((r = "function" == typeof t ? t : Xb(+t)), a)
            : r;
        }),
        (a.endAngle = function (t) {
          return arguments.length
            ? ((i = "function" == typeof t ? t : Xb(+t)), a)
            : i;
        }),
        (a.padAngle = function (t) {
          return arguments.length
            ? ((o = "function" == typeof t ? t : Xb(+t)), a)
            : o;
        }),
        a
      );
    ...
    (t.scaleDivergingPow = x_),
    (t.scaleDivergingSqrt = function () {
      return x_.apply(null, arguments).exponent(0.5);
    }),
    ...
    (t.scaleIdentity = function t(n) {
      ...
      return (
        ...
        (n = arguments.length ? Array.from(n, Up) : [0, 1]),
        Vp(r)
      );
    }),
    (t.scaleImplicit = Rp),
    ...
    (t.scaleLog = function t() {
      ...
      return (
        (n.copy = () => $p(n, t()).base(n.base())), zp.apply(n, arguments), n
      );
    }),
    (t.scaleOrdinal = Fp),
    ...
    (t.scaleRadial = function t() {
      ...
      return (
        ...
        (o.range = function (t) {
          return arguments.length
            ? (e.range((r = Array.from(t, Up)).map(lg)), o)
            : r.slice();
        }),
    ...
    (t.scaleSequentialSqrt = function () {
      return b_.apply(null, arguments).exponent(0.5);
    }),
    ...
    (t.scaleTime = function () {
      return zp.apply(
        y_(Uy, Iy, ry, ty, Ig, qg, Dg, Cg, Eg, t.timeFormat).domain([
          new Date(2e3, 0, 1),
          new Date(2e3, 0, 2),
        ]),
        arguments
    ...
    (t.scaleUtc = function () {
      return zp.apply(
        y_(qy, Oy, Dy, Cy, gy, hy, fy, ay, Eg, t.utcFormat).domain([
          Date.UTC(2e3, 0, 1),
          Date.UTC(2e3, 0, 2),
        ]),
        arguments
    ...
    (t.selectAll = function (t) {
      return "string" == typeof t
        ? new Un([document.querySelectorAll(t)], [document.documentElement])
        : new Un([Dt(t)], On);
    }),
    (t.selection = In),
    (t.selector = zt),
    ...
    (t.stack = function () {
      ...
      function i(i) {
        var o,
          a,
          u = Array.from(t.apply(this, arguments), Xx),
          c = u.length,
          f = -1;
        for (const t of i)
          for (o = 0, ++f; o < c; ++o)
      ...
      return (
        (i.keys = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : Xb(Array.from(n))), i)
            : t;
        }),
        (i.value = function (t) {
          return arguments.length
            ? ((r = "function" == typeof t ? t : Xb(+t)), i)
            : r;
        }),
        (i.order = function (t) {
          return arguments.length
    ...
    (t.stackOrderAppearance = Gx),
    (t.stackOrderAscending = Wx),
      ...
      function r(r) {
        ...
        if (null != t) {
          const n = h.map((n, e) =>
            ...
            i = new Set(n).add("");
          for (const t of e)
            i.has(t) || (i.add(t), n.push(t), e.push(Kd(t)), h.push(Vd));
          (d = (t, e) => n[e]), (p = (t, n) => e[n]);
        }
        ...
        if (null != t) {
          for (; u.data === Vd && 1 === u.children.length; )
            (u = u.children[0]), --i;
          for (let t = h.length - 1; t >= 0 && ((f = h[t]), f.data === Vd); --t)
            f.data = null;
        }
        if (
          ((u.parent = Xd),
    ...
    (t.symbol = function (t, n) {
      ...
      return (
        (t = "function" == typeof t ? t : Xb(t || Bm)),
        (n = "function" == typeof n ? n : Xb(void 0 === n ? 64 : +n)),
        (r.type = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : Xb(n)), r)
            : t;
        }),
        (r.size = function (t) {
          return arguments.length
            ? ((n = "function" == typeof t ? t : Xb(+t)), r)
            : n;
        }),
    ...
    (t.thresholdFreedmanDiaconis = function (t, n, e) {
      return Math.ceil(
        (e - n) / (2 * (Z(t, 0.75) - Z(t, 0.25)) * Math.pow(l(t), -1 / 3))
      );
    }),
    ...
    (t.timeDay = qg),
    (t.timeDays = Og),
    (t.timeFormatDefaultLocale = c_),
    (t.timeFormatLocale = jy),
    (t.timeFriday = $g),
    (t.timeFridays = Kg),
    (t.timeHour = Dg),
    (t.timeHours = Rg),
    (t.timeInterval = gg),
    (t.timeMillisecond = vg),
    (t.timeMilliseconds = _g),
    (t.timeMinute = Cg),
    (t.timeMinutes = Pg),
    (t.timeMonday = Bg),
    (t.timeMondays = Gg),
            ...
            for (
              ...
              (c = tp(c)),
                ...
                (i = u.z + l - o.z - f + t(u._, o._)) > 0 &&
                  (ep(rp(u, n, r), n, i), (f += i), (s += i)),
                (l += u.m),
                (f += o.m),
                (h += c.m),
                (s += a.m);
            u && !np(a) && ((a.t = u), (a.m += l - s)),
              o && !tp(c) && ((c.t = o), (c.m += f - h), (r = n));
          }
          return r;
        })(n, i, n.parent.A || r[0]);
      }
    ...
    (t.treemap = function () {
      ...
      return (
        ...
        (s.paddingTop = function (t) {
          return arguments.length
            ? ((a = "function" == typeof t ? t : Ad(+t)), s)
            : a;
        }),
        (s.paddingRight = function (t) {
          return arguments.length
            ? ((u = "function" == typeof t ? t : Ad(+t)), s)
            : u;
        }),
        (s.paddingBottom = function (t) {
          return arguments.length
            ? ((c = "function" == typeof t ? t : Ad(+t)), s)
            : c;
        }),
        (s.paddingLeft = function (t) {
          return arguments.length
            ? ((f = "function" == typeof t ? t : Ad(+t)), s)
            : f;
        }),
        s
      );
