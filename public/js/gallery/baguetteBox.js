...
var baguetteBox = (function() {
	...
	var galleries = [];
	// 2D array of galleries and img inside them
	var imagesMap = [];
	// Array containing temporary img DOM elements
	var imagesElements = [];
	...
	function run(selector, userOptions) {
		...
		[].forEach.call(
			...
			function (galleryElement, galleryIndex) {
				// Filter 'a' elements from those not linking to img
				var tags = galleryElement.getElementsByTagName('a');
				tags = [].filter.call(tags, function(element) {
					return regex.test(element.href);
				});

				// Get all gallery img and save them in imagesMap with custom options
	...
	function prepareOverlay(galleryIndex) {
		...
		// Prepare and append img containers
